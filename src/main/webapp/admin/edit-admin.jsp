...
<form method="post">
  ...
  <div class="row mb-5">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="price" name="price" value="${e.getPrice()}">
    </div>
  </div>
  <div class="row mb-5">
    <label for="quantity" class="col-sm-2 col-form-label">Quantity</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="quantity" name="quantity" value="${e.getQuantity()}">
    </div>
  </div>
  <div class="row mb-5">
